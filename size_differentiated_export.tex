...
\soulregister\ref7 % For references and citation to work within trackchanges
\soulregister\cite7
...
\begin{document}
    ...
    \add{Junge slopes are expected to vary in space, depending on the community composition, both lateraly and vertically} \citep{Kostadinov_2009, White_2015}\add{, as well as in time; spectrum slopes tend to be flatter during a spring bloom event, where larger particles (e.g., diatoms) are produced in large quantities (cite cite cite), and steeper during the wintertime, when communities are mostly composed of small particles (cite cite cite)}.
