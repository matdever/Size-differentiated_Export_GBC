...
for tt = 1:0.125:25
    ...
    [wt0025s(:,counter)] = importw(['/vortexfs1/share/mahadevanlab/mathieudever/particle_backup/particlespeed/Papa_summer/w0025mday_summer_doy',summernum,'.csv']);
    [wt1s(:,counter)] = importw(['/vortexfs1/share/mahadevanlab/mathieudever/particle_backup/particlespeed/Papa_summer/w1mday_summer_doy',summernum,'.csv']);
    [wt5s(:,counter)] = importw(['/vortexfs1/share/mahadevanlab/mathieudever/particle_backup/particlespeed/Papa_summer/w5mday_summer_doy',summernum,'.csv']);
    ...
    [wt0025w(:,counter)] = importw(['/vortexfs1/share/mahadevanlab/mathieudever/particle_backup/particlespeed/Papa_winter/w0025mday_winter_doy',winternum,'.csv']);
    [wt1w(:,counter)] = importw(['/vortexfs1/share/mahadevanlab/mathieudever/particle_backup/particlespeed/Papa_winter/w1mday_winter_doy',winternum,'.csv']);
    [wt5w(:,counter)] = importw(['/vortexfs1/share/mahadevanlab/mathieudever/particle_backup/particlespeed/Papa_winter/w5mday_winter_doy',winternum,'.csv']);
    counter = counter +1;
...
clear wt*
% Save the rest
save /vortexfs1/home/mdever/Fig7/Fig7_data_v2.mat
