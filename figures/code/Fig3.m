...
load('/Volumes/mdever/1-Projects/EXPORTS/Data/station_Papa_glider/glider_non_gridded.mat')
...
% Heat Fluxes
fileID = fopen('/Volumes/mahadevanlab/mathieudever/PSOM_backup/PSOM_configuration/Papa_winter/ini_heatfluxes_108s.in','r');
...
% Windstress
fileID = fopen('/Volumes/mahadevanlab/mathieudever/PSOM_backup/PSOM_configuration/Papa_winter/ini_windstress_108s.in','r');
